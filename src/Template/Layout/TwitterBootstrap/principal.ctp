<head>
	<title>Publicize a Corporate Category Bootstrap Responsive Website Template </title>
	<!-- custom-theme -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!-- //custom-theme -->
	<link href="css/principal/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
	<!-- Owl-carousel-CSS -->
	<link href="css/principal/owl.carousel.css" rel="stylesheet">
	<link rel="stylesheet" href="css/principal/team.css" type="text/css" media="all" />
	<link href="css/principal/style.css" rel="stylesheet" type="text/css" media="all" />
	<!-- font-awesome-icons -->
	<link href="css/principal/font-awesome.css" rel="stylesheet">
	<!-- //font-awesome-icons -->
...
<body>
	...
	<div class="banner_top">
		<div class="slider">
			<div class="wrapper">
				...
				<!-- Slideshow 3 Pager -->
				<ul id="slider3-pager">
					<li><a href="#"><img src="img/principal/banner11.jpg" data-selector="img" alt=""></a></li>
					<li><a href="#"><img src="img/principal/banner22.jpg" data-selector="img" alt=""></a></li>
					<li><a href="#"><img src="img/principal/banner33.jpg" data-selector="img" alt=""></a></li>
					<li><a href="#"><img src="img/principal/banner44.jpg" data-selector="img" alt=""></a></li>
		...
		<div class="container">
			...
			<div class="agile_wthree_inner_grids">
				...
				<div class="col-md-6 about_agileinfo_grid_imgs">
					<img src="img/principal/about.jpg" alt="" />
				</div>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<div class="modal-info">
						<h4>Publicize</h4>
						<img src="img/principal/banner2.jpg" alt=" " class="img-responsive" />
		...
		<div class="container">
			...
			<div class="agile_wthree_inner_grids">
				<div class="col-md-4 w3_agile_team_grid_info">
					<img src="img/principal/t1.jpg" alt=" " class="img-responsive" />
					<h3>Jane Mycle </h3>
					<p>CEO</p>
				...
				<div class="col-md-4 w3_agile_team_grid_info">
					<img src="img/principal/t2.jpg" alt=" " class="img-responsive" />
					<h3>Amanda Seylon </h3>
					<p>Manager</p>
					<div class="agileits_w3layouts_nav_right team_agile _icons">
						<ul>
				...
				<div class="col-md-4 w3_agile_team_grid_info">
					<img src="img/principal/t3.jpg" alt=" " class="img-responsive" />
					<h3>Laura Mark</h3>
					<p>Designer</p>
					<div class="agileits_w3layouts_nav_right team_agile _icons">
						<ul>
			...
			<div class="agile_port_w3ls_info">
				<div class="portfolio-grids_main">
					<div class="col-md-6 portfolio-grids gallery-grid1" data-aos="zoom-in">
						<a href="img/principal/g1.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="img/principal/g1.jpg" class="img-responsive" alt="w3ls" />
								<div class="p-mask">
					...
					<div class="col-md-6 portfolio-grid_left">
						<div class="col-md-6 portfolio-grids gallery-grid1" data-aos="zoom-in">
							<a href="img/principal/g5.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
									<img src="img/principal/g5.jpg" class="img-responsive" alt="w3ls" />
									<div class="p-mask">
										<h4><span>Heading here</span></h4>
										<p>Neque porro quisquam est.</p>
									</div>
						...
						<div class="col-md-6 portfolio-grids gallery-grid1" data-aos="zoom-in">
							<a href="img/principal/g4.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
									<img src="img/principal/g4.jpg" class="img-responsive" alt="w3ls" />
									<div class="p-mask">
										<h4><span>Heading here</span></h4>
										<p>Neque porro quisquam est.</p>
									</div>
				...
				<div class="portfolio-grids_main">
					...
					<div class="col-md-6 portfolio-grid_left">
						<div class="col-md-6 portfolio-grids gallery-grid1" data-aos="zoom-in">
							<a href="img/principal/g6.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
									<img src="img/principal/g6.jpg" class="img-responsive" alt="w3ls" />
									<div class="p-mask">
										<h4><span>Heading here</span></h4>
										<p>Neque porro quisquam est.</p>
									</div>
						...
						<div class="col-md-6 portfolio-grids gallery-grid1" data-aos="zoom-in">
							<a href="img/principal/g3.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
									<img src="img/principal/g3.jpg" class="img-responsive" alt="w3ls" />
									<div class="p-mask">
										<h4><span>Heading here</span></h4>
										<p>Neque porro quisquam est.</p>
									</div>
					...
					<div class="col-md-6 portfolio-grids gallery-grid1" data-aos="zoom-in">
						<a href="img/principal/g2.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="img/principal/g2.jpg" class="img-responsive" alt="w3ls" />
								<div class="p-mask">
										<h4><span>Heading here</span></h4>
										<p>Neque porro quisquam est.</p>
									</div>
							...
							<div class="test-grid">
								...
								<div class="test-grid1">
									<div class="test-grid2">
										...
										<img src="img/principal/1.png" alt="" class="img-r">
									</div>
							...
							<div class="test-grid">
								...
								<div class="test-grid1">
									<div class="test-grid2">
										...
										<img src="img/principal/2.png" alt="" class="img-r">
									</div>
									<div class="test-grid2_text">
										<h4>Steve Warner</h4>
										<span>Client</span>
							...
							<div class="test-grid">
								...
								<div class="test-grid1">
									<div class="test-grid2">
										...
										<img src="img/principal/3.png" alt="" class="img-r">
									</div>
									<div class="test-grid2_text">
										<h4>James Warner</h4>
										<span>Client</span>
				...
				<div class="col-md-4 w3layouts_footer_grid">
					<h3>Recent <span>Works</span></h3>
					 <ul class="con_inner_text midimg">
						<li><a href="#"><img src="img/principal/banner22.jpg" alt="" class="img-responsive" /></a></li>
					    <li><a href="#"><img src="img/principal/banner33.jpg" alt="" class="img-responsive" /></a></li>
						<li><a href="#"><img src="img/principal/banner44.jpg" alt="" class="img-responsive" /></a></li>
						<li><a href="#"><img src="img/principal/banner11.jpg" alt="" class="img-responsive" /></a></li>
						<li><a href="#"><img src="img/principal/banner22.jpg" alt="" class="img-responsive" /></a></li>
					    <li><a href="#"><img src="img/principal/banner33.jpg" alt="" class="img-responsive" /></a></li>
						 <li><a href="#"><img src="img/principal/banner11.jpg" alt="" class="img-responsive" /></a></li>
						<li><a href="#"><img src="img/principal/banner44.jpg" alt="" class="img-responsive" /></a></li>
	...
	<!-- js -->
	<script type="text/javascript" src="js/principal/jquery-2.1.4.min.js"></script>
	<!-- //js -->
	<!-- stats -->
	<script src="js/principal/jquery.waypoints.min.js"></script>
	<script src="js/principal/jquery.countup.js"></script>
	<script>
		$('.counter').countUp();
	</script>
	<!-- //stats -->
	<!-- Slider script -->
	<script src="js/principal/responsiveslides.min.js"></script>
	<script>
	...
	<script src="js/principal/modernizr-2.6.2.min.js"></script>
	<!-- //nav -->
	<!-- js for portfolio lightbox -->
	<script src="js/principal/jquery.chocolat.js "></script>
	<link rel="stylesheet " href="css/principal/chocolat.css " type="text/css" media="all" />
	<!--light-box-files -->
	...
	<script type="text/javascript" src="js/principal/bootstrap-3.1.1.min.js"></script>
